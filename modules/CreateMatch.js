...
export default class CreateMatch extends React.Component {
	...
	constructor(props) {
        ...
        this.state = {email: this.props.navigation.state.params.email, tournament: this.props.navigation.state.params.tournament,
            date: '', p1name: '', p1from: '', p2name: '', p2from: '', round: '', division: '',
            matchFormat: '1', scoringFormat: '1', referee: ''};
	}
                ...
                <View style={styles.subView}>
					<View style={{flex:1}}>
                        ...
                        <Picker
                            ...
                            <Picker.Item label="Best of two tiebreak sets and match tiebreak" value="2" />
