      ...
      userRef
        ...
        .then(ss => {
          if (!ss.exists() || newUmpire == "") {
            ...
            newUmpire == tournament.admin.toLowerCase().replace(".", ",")
          ) {
            replace("ManageUmpires", {
              email: email,
              error: "alreadyAdded",
    ...
    if (error == "noUser") {
      errorLabel = (
        <Text style={styles.errorLabels}>
          Umpire: {modedUmpire.replace(",", ".")} does not exist!
        </Text>
      );
    } else if (error == "alreadyAdded") {
      errorLabel = (
        <Text style={styles.errorLabels}>
          Umpire: {modedUmpire.replace(",", ".")} already added!
        </Text>
      );
    } else if (error == "success") {
      errorLabel = (
        <Text style={styles.successLabels}>
          Umpire: {modedUmpire.replace(",", ".")} added!
        </Text>
      );
    } else if (error == "removed") {
      errorLabel = (
        <Text style={styles.errorLabels}>
          Umpire: {modedUmpire.replace(",", ".")} removed!
        </Text>
      );
    ...
    if (tournament.umpires != null) {
      tournament.umpires.forEach(umpire => {
        umpires.push(
          <TouchableOpacity
            key={umpire}
            onPress={() => this.deleteUmpire(umpire)}
          >
