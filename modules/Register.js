  ...
  constructor(props) {
    ...
    if (this.props.navigation.state.params.error) {
      const {
        ...
        fillName,
        fillPassword
      } = this.props.navigation.state.params.fillFields;
      const {
        validEmail,
        validName,
        validPassword,
        emailTaken
      } = this.props.navigation.state.params.validFields;
      ...
      userRef
        ...
        .then(ss => {
          if (ss.exists()) {
            ...
            userRef
              .child(email.toLowerCase().replace(".", ","))
              .set({ password: hashCode(password), name: name });
            pop();
          }
        });
    } else {
  ...
  render() {
    ...
    if (this.state.validEmail) {
      if (this.state.emailTaken) {
        emailLabel = (
          <Text style={styles.errorLabels}>Email - Email already in use!</Text>
        );
      } else {
      ...
      emailLabel = (
        <Text style={styles.errorLabels}>Email - Invalid Email</Text>
      );
    }
    ...
    if (this.state.validPassword) {
      ...
      passwordLabel = (
        <Text style={styles.errorLabels}>Password - Invalid password</Text>
      );
    }
    return (
